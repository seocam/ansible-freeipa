...
def main():
    ...
    env = gen_env_boostrap_finalize_core(
        paths.ETC_IPA, constants.DEFAULT_CONFIG
    )
    ...
    with redirect_stdout(ansible_log):
        try:
            ...
            cafile = install_ca_cert(
                conn, api.env.basedn, api.env.realm, cafile
            )
            install_ca_cert(
                conn,
                api.env.basedn,
