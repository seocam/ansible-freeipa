...
def main():
    ansible_module = AnsibleModule(
        argument_spec=dict(
            ...
            usercategory=dict(
                required=False, type="str", default=None, choices=["all"]
            ),
            hostcategory=dict(
                required=False, type="str", default=None, choices=["all"]
            ),
            ...
            runasusercategory=dict(
                required=False, type="str", default=None, choices=["all"]
            ),
            runasgroupcategory=dict(
                required=False, type="str", default=None, choices=["all"]
            ),
            ...
            sudooption=dict(
                required=False, type="list", default=None, aliases=["options"]
            ),
            action=dict(
                type="str", default="sudorule", choices=["member", "sudorule"]
            ),
            # state
            state=dict(
                type="str",
    ...
    runasusercategory = module_params_get(
        ansible_module, "runasusercategory"
    )  # noqa
    runasgroupcategory = module_params_get(
        ansible_module, "runasgroupcategory"
    )  # noqa
    hostcategory = module_params_get(ansible_module, "hostcategory")  # noqa
    ...
    allow_sudocmdgroup = module_params_get(
        ansible_module, "allow_sudocmdgroup"
    )
